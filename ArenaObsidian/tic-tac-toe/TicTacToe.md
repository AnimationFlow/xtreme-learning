from : https://learn.microsoft.com/en-us/samples/dotnet/samples/orleans-tictactoe-web-based-game/
...
The game is implemented as a single project, `TicTacToe.csproj`, which uses the [.NET Generic Host](https://learn.microsoft.com/en-us/dotnet/core/extensions/generic-host) to host an ASP.NET Core MVC application alongside Orleans.
...
![A diagram showing the calls made in the application](https://learn.microsoft.com/en-us/samples/dotnet/samples/orleans-tictactoe-web-based-game/media/dataflow.png)
...
3. From the command line:
    ...
    2. At the command line, type [`dotnet run`](https://learn.microsoft.com/en-us/dotnet/core/tools/dotnet-run).
...
Since the game uses cookies to identify players, you will need a separate browser session to be able to play against yourself and experience the game.
 ...
 ![[Pasted image 20260227103040.png]]
